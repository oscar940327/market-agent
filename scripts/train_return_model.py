...
from ml_return_model import train_return_models, write_return_model_outputs  # noqa: E402
...
DEFAULT_MODEL_DIR = PROJECT_ROOT / "data" / "ml" / "return_models"


def main() -> int:
    parser = argparse.ArgumentParser(description="Train Step 7.8B return models.")
