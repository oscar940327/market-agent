...
| `monthly-model-promotion.yml` | 每月 2 日 `15:00` | 每月 2 日 `07:00 UTC` | 重訓候選模型、執行 walk-forward 比較、shadow review 並寄出明確模型建議 |
...
模型定期比較與 shadow validation：[Model Promotion](model_promotion.md)
